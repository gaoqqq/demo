    ...
    <div>
        ...
        <div class="cond-body" :style="height">
            <el-form :model="collectForm" :rules="rules" ref="ruleForm" label-width="120px" label-position="left" class="demo-ruleForm">
                <el-row><el-col :span="8"><el-form-item label="姓名"><el-input v-model="collectForm.userName" placeholder="请填写姓名"></el-input></el-form-item></el-col></el-row>
                  <el-row><el-col :span="8"><el-form-item label="身份证号"><el-input v-model="collectForm.numId" placeholder="请填写身份证号"></el-input></el-form-item></el-col></el-row>
                <el-row><el-col :span="8"><el-form-item label="性别">
                 ...
                 <el-row><el-col :span="8"><el-form-item label="手机号码"><el-input v-model="collectForm.contact" placeholder="请填写手机号码"></el-input></el-form-item></el-col></el-row>
                 <el-row>
                    <el-col :span="8">
                        <el-form-item label="员工类型">
                            <el-select v-model="collectForm.type" placeholder="请选择员工类型">
                 ...
                 <el-row>
                    <el-col :span="8">
                        <el-form-item label="所属团队">
                            <el-select v-model="collectForm.team" placeholder="请选择员工类型" class="handle-select mr10">
                                <el-option key="1" label="华行资产" value="华行资产"></el-option>
                                <el-option key="2" label="中信银行" value="中信银行"></el-option>
                                <el-option key="3" label="金厚资产" value="金厚资产"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row><el-col :span="8"><el-form-item label="用户名"><el-input v-model="collectForm.userName" placeholder="请输入用户名"></el-input></el-form-item></el-col></el-row>
                <el-row><el-col :span="8"><el-form-item label="角色"><el-input v-model="collectForm.role" placeholder="请输入角色"></el-input></el-form-item></el-col></el-row>
