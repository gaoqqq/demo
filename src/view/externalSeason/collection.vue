<template>
    <div id="collec">
        ...
        <el-form ref="conditionForm" :model="conditionForm" label-width="100px">
            <el-row>
            <el-col :span="6"><el-form-item label="机构名称"><el-input placeholder="请输入机构名称" class="cond-input"></el-input></el-form-item></el-col>
            <el-col :span="6"><el-form-item label="机构负责人"><el-input placeholder="请输入机构负责人" class="cond-input"></el-input></el-form-item></el-col>
            <el-col :span="6">
        ...
        <div class="cond-body" :style="height">
            ...
            >
                <el-table-column prop="agencyNo" label="机构编号" align="center"></el-table-column>
        ...
        <el-dialog :title="editform.agencyName" :visible.sync="editVisible" width="35%" top="3%">
            <el-form ref="form" :model="editform" label-width="80px" label-position="left">
                <el-row><el-col :span="20"><el-form-item label="机构编号"><span style="margin-left:1px;">{{editform.agencyNo}}</span></el-form-item></el-col></el-row>
                <el-row><el-col :span="20"><el-form-item label="机构状态" prop="state">
...
export default {
    ...
    methods: {
        ...
        handleDeta(index,row) {//查看
            this.editform = {...row};
            this.editform.agencyName = '机构名称:'+this.editform.agencyName;
