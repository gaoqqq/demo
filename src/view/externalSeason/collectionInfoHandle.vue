    ...
    <div>
        ...
        <div class="cond-body" :style="height">
            <el-form :model="collectForm" :rules="rules" ref="ruleForm" label-width="80px" label-position="left" class="demo-ruleForm">
                <el-row><el-col :span="8"><el-form-item label="机构编号"><span style="margin-left:1px;">{{collectForm.agencyNo}}</span></el-form-item></el-col></el-row>
                <el-row><el-col :span="8"><el-form-item label="机构名称" prop="agencyName"><el-input v-model="collectForm.agencyName" placeholder="请填写机构名称"></el-input></el-form-item></el-col></el-row>
                <el-row><el-col :span="8"><el-form-item label="机构状态" prop="state">
