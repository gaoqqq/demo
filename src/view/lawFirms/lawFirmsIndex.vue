<template>
    <div id="collec">
        ...
        <el-form ref="conditionForm" :model="conditionForm" label-width="100px">
            <el-row>
            <el-col :span="6"><el-form-item label="律所名称"><el-input placeholder="请输入律所名称" class="cond-input"></el-input></el-form-item></el-col>
            <el-col :span="6"><el-form-item label="律所负责人"><el-input placeholder="请输入律所负责人" class="cond-input"></el-input></el-form-item></el-col>
            <el-col :span="6">
                <el-form-item label="律所状态">
                    <el-select v-model="conditionForm.name" placeholder="请选择律所状态" class="handle-select mr10">
                        <el-option key="1" label="停用" value="停用"></el-option>
                        <el-option key="2" label="启用" value="启用"></el-option>
                    </el-select>
                </el-form-item>
            </el-col>
            <el-col :span="6">
        ...
        <div class="cond-body" :style="height">
            ...
            >
                <el-table-column prop="agencyNo" label="律所编号" align="center"></el-table-column>
                <el-table-column prop="agencyName" label="律所名称" align="center"></el-table-column>
        ...
        <el-dialog :title="editform.agencyName" :visible.sync="editVisible" width="35%" top="3%">
            <el-form ref="form" :model="editform" label-width="80px" label-position="left">
                <el-row><el-col :span="20"><el-form-item label="律所编号"><span style="margin-left:1px;">{{editform.agencyNo}}</span></el-form-item></el-col></el-row>
                <el-row><el-col :span="20"><el-form-item label="律所状态" prop="state">
                ...
                <el-row><el-col :span="20"><el-form-item label="备注" prop="memo">
                    <el-input type="textarea" rows="4" v-model="editform.memo" placeholder="请填写律所备注"></el-input>
                </el-form-item></el-col></el-row>
            </el-form>
        </el-dialog>
    </div> 
...
export default {
    ...
    methods: {
        ...
        handleDeta(index,row) {//查看
            this.editform = {...row};
            this.editform.agencyName = '律所名称:'+this.editform.agencyName;
...
<style>
#collec .el-dialog__body{
    padding-top: 5px;
}
#collec .el-form-item--mini.el-form-item, .el-form-item--small.el-form-item{
    margin-bottom: 13px;
}
#collec .el-dialog__header{
    background: #E3ECF6;
}
</style>